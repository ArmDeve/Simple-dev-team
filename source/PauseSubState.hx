...
class PauseSubState extends MusicBeatSubstate
{
	...
	var menuItems:Array<String> = ['Resume', 'Restart Song', 'Options',  'Skip Song', 'Exit to menu'];
...
Preferences.isPauseSubState = true;
		...
		FlxTween.tween(checkers, {alpha: 0.4}, 0.5, {ease: FlxEase.quartInOut});
	...
	override function update(elapsed:Float)
	{
		...
		if (accepted)
		{
			switch (curSelected)
			{
				...
				case 2:
					Preferences.isPauseSubState = true;
                    nextState(new options.Preferences(), false, true);
				case 3:
					PlayState.instance.endSong();
				case 4:
					nextState(new MainMenuState(), false, true);
			}
		}
	}
