...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = '', ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter) {
			case 'bf'|'bf-christmas'|'bf-car':
			iconColor = FlxColor.fromString('#31B0D1');
			case 'bf-pixel':
				iconColor = FlxColor.fromString('#7BD6F6');
			case 'gf'|'gf-christmas'|'gf-car'|'gf-pixel':
			iconColor = FlxColor.fromString('#A5004D');
			case 'pico':
				iconColor = FlxColor.fromString('#B7D855');
			case 'spooky':
				iconColor = FlxColor.fromString('#dd947f');
			case 'monster':
				iconColor = FlxColor.fromString('#F2FF6D');
			case 'dad':
				iconColor = FlxColor.fromString('#BD7BD3');
			case 'mom'|'mom-car':
				iconColor = FlxColor.fromString('#D8558E');
			case 'parents-christmas':
				iconColor = FlxColor.fromString('#cb6ab4');
			case 'senpai'|'senpai-angry':
				iconColor = FlxColor.fromString('#FFAA6F');
			case 'spirit':
				iconColor = FlxColor.fromString('#FF3C6E');
			}
		...
		switch (curCharacter)
		{
			...
			case 'pico':
				...
				frames = tex;
				animation.addByPrefix('blammed', 'blammed', 24, false);
				...
				addOffset('idle');
				addOffset("singUP", -41, 20);
				addOffset("singRIGHT", -80, -11);
				addOffset("singLEFT", 53, 1);
				addOffset("singDOWN", 184, -84);
				addOffset("singUPmiss", -25, 55);
				addOffset("singRIGHTmiss", -77, 24);
				addOffset("singLEFTmiss", 51, 45);
				addOffset("singDOWNmiss", 182, -44);
				addOffset('blammed', 62, 9);
