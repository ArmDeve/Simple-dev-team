...
class StoryMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		for (i in 0...story.weekData.length)
		{
			...
			weekThing.antialiasing = PreferencesOptions.Antialiasing;
			...
			if (!weekUnlocked[i])
			{
				...
				lock.ID = i;
				lock.antialiasing = PreferencesOptions.Antialiasing;
				grpLocks.add(lock);
			}
		}
		...
		txtTracklist = new FlxText(FlxG.width * 2.05, yellowBG.x + yellowBG.height + 100, 0, "Tracks", 32);
	...
	override function update(elapsed:Float)
	{
		...
		if (FlxG.keys.justPressed.F)
			{
				grpWeekCharacters.members[0].scale.set(10, 10);
				trace(grpWeekCharacters.members[0].scale.x + ',' + grpWeekCharacters.members[0].scale.y);
			//grpWeekCharacters.members[0].offset.x += 10;
		//	trace('x +'+grpWeekCharacters.members[0].offset.x);
			}
		...
		//		trace('x -'+grpWeekCharacters.members[0].offset.x);
			...
			{
				grpWeekCharacters.members[0].offset.y += 10;
				trace('y +'+grpWeekCharacters.members[0].offset.y);
			}
	...
	function updateText()
	{
		...
		switch (grpWeekCharacters.members[0].animation.curAnim.name)
		{
			case 'parents-christmas':
				...
				grpWeekCharacters.members[0].offset.set(250, 180);
				grpWeekCharacters.members[0].setGraphicSize(Std.int(grpWeekCharacters.members[0].width * 1.55));
case 'pico':
grpWeekCharacters.members[0].flipX = true;
grpWeekCharacters.members[0].offset.set(165, 90);
grpWeekCharacters.members[0].setGraphicSize(Std.int(grpWeekCharacters.members[0].width * 1.25));
			...
			case 'mom':
				grpWeekCharacters.members[0].flipX = false;
				grpWeekCharacters.members[0].offset.set(165, 200);
				grpWeekCharacters.members[0].setGraphicSize(Std.int(grpWeekCharacters.members[0].width * 0.75));
case 'spooky':
	grpWeekCharacters.members[0].offset.set(175, 120);
	grpWeekCharacters.members[0].flipX = false;
	grpWeekCharacters.members[0].setGraphicSize(Std.int(grpWeekCharacters.members[0].width * 1.25));
			case 'dad':
				grpWeekCharacters.members[0].flipX = false;
